...
if(SGX_FOUND)
    ...
    if(SGX_MODE STREQUAL "Debug")
        ...
        set(SGX_COMMON_CFLAGS "${SGX_COMMON_CFLAGS} -O3 -g -DDEBUG -UNDEBUG -UEDEBUG")
    elseif(SGX_MODE STREQUAL "PreRelease")
        message(STATUS "SGX PreRelease Mode")
        set(SGX_COMMON_CFLAGS "${SGX_COMMON_CFLAGS} -O2 -g -UDEBUG -DNDEBUG -DEDEBUG")
